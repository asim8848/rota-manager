...
const Header = ({
  ...
  return (
    <header className="fixed left-0 right-0 top-4 z-30 mx-auto w-[calc(100%-4rem)] max-w-none">
      <div className="panel flex flex-wrap items-center justify-between gap-4 px-5 py-3">
        {/* Brand Identity / Inline SVG Logo */}
        <div className="flex items-center gap-3">
          <a href="#" className="flex items-center gap-2.5 group" aria-label="Smoke and Pepper Rota">
            ...
            <div className="h-8 flex items-center">
              <svg 
                ...
                className="h-5.5 w-auto text-text transition-colors duration-300"
              >
                <path 
                  id="smoke" 
            ...
            {/* Subtext Badge */}
            <div className="tag flex items-center border border-accent/20 bg-accent-soft px-1.5 py-0.5 text-[8.5px] font-bold text-accent tracking-widest leading-none rounded">
              ROTA
            </div>
          </a>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          {status ? (
            <div className="tag flex items-center gap-1.5 border border-primary/20 bg-accent-soft px-3 py-1 text-xs text-accent shadow-sm animate-slide-down">
          ...
          <button 
            ...
            className="btn text-xs tracking-wide font-semibold"
          >
            <CameraIcon className="w-4 h-4 mr-0.5" />
          ...
          <button 
            ...
            className="btn btn-soft text-xs tracking-wide px-3"
